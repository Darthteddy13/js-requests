...
const repeatMyParam = () => {
    ...
    axios.get(`http://localhost:3000/repeat/somethingrandom`)
...
const queryBtnFunc = () => {
    axios.get('http://localhost:3000/query-test?stuff=things?moreStuff=moreThings', )
...
document.getElementById(`query-button`).addEventListener(`click`, queryBtnFunc)
...
const createFood = () => {
    ...
    foodInput = document.getElementById(`food-Text`).text;
